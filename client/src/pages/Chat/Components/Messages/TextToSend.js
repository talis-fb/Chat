...
function Text(props){
    ...
    function handle_typing(event){
        ...
        setText(value_in_box)
    }

    function send(){
        props.send_message(text) // Envia a mensagem
    ...
    return(
        <div className="box-text">
            <textarea id="text-box" type="text" placeholder="Digite Aqui..." className="text" onChange={handle_typing} ></textarea>
            <button onClick={send}>
